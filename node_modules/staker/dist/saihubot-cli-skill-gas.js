...
var _saihubotAdapterGas = require("./saihubot-adapter-gas");
...
const skillGasTracker = {
  ...
  action: function (robot, msg) {
    ...
    robot.render();
    (0, _saihubotAdapterGas.fetchGas)(robot.addons.fetch, _saihubotAdapterGas.GAS_ESTIMATOR.GASTRACKER, data => {
...
const skillGasStation = {
  ...
  action: function (robot, msg) {
    ...
    robot.render();
    (0, _saihubotAdapterGas.fetchGas)(robot.addons.fetch, _saihubotAdapterGas.GAS_ESTIMATOR.GASSTATION, data => {
      robot.sendComponent( /*#__PURE__*/_React.default.createElement(_ink.Text, null, (0, _i18n.t)('gasfee', {
        i18n: i18nGas,
        ...data
      })));
...
const skillGasNow = {
  ...
  action: function (robot, msg) {
    ...
    robot.render();
    (0, _saihubotAdapterGas.fetchGas)(robot.addons.fetch, _saihubotAdapterGas.GAS_ESTIMATOR.GASNOW, data => {
      robot.sendComponent( /*#__PURE__*/_React.default.createElement(_ink.Text, null, (0, _i18n.t)('gasfee', {
        i18n: i18nGas,
        ...data
      })));
...
const skillGasPriceOracle = {
  ...
  action: function (robot, msg) {
    ...
    robot.render();
    (0, _saihubotAdapterGas.fetchGas)(robot.addons.fetch, _saihubotAdapterGas.GAS_ESTIMATOR.GASPRICEORACLE, data => {
      robot.sendComponent( /*#__PURE__*/_React.default.createElement(_ink.Text, null, (0, _i18n.t)('gasfee', {
        i18n: i18nGas,
        ...data
      })));
