...
exports.addons = exports.addonFetchGas = exports.GAS_ESTIMATOR = exports.fetchGas = void 0;

function int(num) {
  return parseInt(num, 10);
}

const fetchGas = (fetch, estimator, callback) => fetch(estimator.api).then(response => response.json()).then(json => {
...
exports.GAS_ESTIMATOR = GAS_ESTIMATOR;
const addonFetchGas = {
  name: 'fetchGas',
  requirements: {
    addons: ['fetch']
  },
  action: robot => (estimator, callback) => fetchGas(robot.addons.fetch, estimator, callback)
};
exports.addonFetchGas = addonFetchGas;
