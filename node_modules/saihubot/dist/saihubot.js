...
function SaihuBot(config) {
  ...
  this.welcomeMessage = config.welcomeMessage || defaultWelcomeMsgs(this.botAlias);
...
SaihuBot.prototype = {
  ...
  restore: function () {
    ...
    this.chatHistory = brainLog && brainLog.length > 1 ? brainLog : this.welcomeMessage && [this.welcomeMessage] || [];
    this.render();
  },
