...
exports.skills = exports.skillSearchCheatsh = exports.skillSearchWolfram = exports.skillSearchStackoverflow = exports.skillSearchTwitter = exports.skillSearchNpm = exports.skillSearchMdn = exports.skillSearchYoutube = exports.skillSearchGoogleTrends = exports.skillSearchGooglemaps = exports.skillSearchGoogleimages = exports.skillSearchGoogletranslate = exports.skillSearchGoogle = exports.skillSearchGithub = exports.skillSearchWikipedia = exports.skillSearchDuckduckgo = void 0;
const skillSearchDuckduckgo = {
  name: 'duckduckgo',
...
exports.skillSearchDuckduckgo = skillSearchDuckduckgo;
const skillSearchWikipedia = {
  name: 'wikipedia',
...
exports.skillSearchWikipedia = skillSearchWikipedia;
const skillSearchGithub = {
  name: 'github',
...
exports.skillSearchGithub = skillSearchGithub;
const skillSearchGoogle = {
  name: 'google',
...
exports.skillSearchGoogle = skillSearchGoogle;
const skillSearchGoogletranslate = {
...
exports.skillSearchGoogletranslate = skillSearchGoogletranslate;
const skillSearchGoogleimages = {
  name: 'googleimages',
...
exports.skillSearchGoogleimages = skillSearchGoogleimages;
const skillSearchGooglemaps = {
  name: 'googlemaps',
...
exports.skillSearchGooglemaps = skillSearchGooglemaps;
const skillSearchGoogleTrends = {
  name: 'googletrends',
...
exports.skillSearchGoogleTrends = skillSearchGoogleTrends;
const skillSearchYoutube = {
  name: 'youtube',
...
exports.skillSearchYoutube = skillSearchYoutube;
const skillSearchMdn = {
  name: 'mdn',
...
exports.skillSearchMdn = skillSearchMdn;
const skillSearchNpm = {
  name: 'npm',
...
exports.skillSearchNpm = skillSearchNpm;
const skillSearchTwitter = {
  name: 'twitter',
...
exports.skillSearchTwitter = skillSearchTwitter;
const skillSearchStackoverflow = {
  name: 'stackoverflow',
...
exports.skillSearchStackoverflow = skillSearchStackoverflow;
const skillSearchWolfram = {
  name: 'wolfram',
...
exports.skillSearchWolfram = skillSearchWolfram;
const skillSearchCheatsh = {
  name: 'cheatsh',
...
exports.skillSearchCheatsh = skillSearchCheatsh;
const skills = [skillSearchDuckduckgo, skillSearchWikipedia, skillSearchGithub, skillSearchGoogle, skillSearchGoogletranslate, skillSearchGoogleimages, skillSearchGooglemaps, skillSearchYoutube, skillSearchMdn, skillSearchNpm, skillSearchTwitter, skillSearchStackoverflow, skillSearchWolfram, skillSearchCheatsh];
